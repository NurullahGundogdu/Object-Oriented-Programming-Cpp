...
public class linkList <E> implements List<E>, queue<E> {
    /**
     * empty array instance used for list element
     */
    private Object[] base;
    /**
     * The size of the linkList (the number of elements it contains).
     */
    private int size;
    /**
     * iterator method create Iterator<E> class type object
    ...
    /**
     * element method take list first element
     * @return e element of list
     */
    public E element(){
    ...
    /**
     * offer method adds an element to list
     * @param e element for list
     */
    ...
    /**
     * poll method take list first element and remove from list
     * @return e element of list
     */
    public E poll(){
        if (size==0) {
            throw new IllegalAccessError("error: no element in this list");
        ...
        Object temp[];  // declare array variable
        temp = new Object[size-1];
        System.arraycopy(base, 1, temp, 0, size - 1);
        base=temp;
        size-=1;
        return e;
